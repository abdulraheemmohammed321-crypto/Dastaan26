...
export default function About() {
  const features = [
    ...
    },
    {
      ...
      desc: "A multi-cuisine buffet featuring signature emerald-themed desserts."
    },
    {
  ...
  return (
    <div className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      >
        <h2 className="text-gold-400 font-serif italic text-xl mb-4">Our Story</h2>
        <h3 className="text-4xl md:text-6xl font-display gold-gradient mb-8">The Legacy of DASTAAN</h3>
        <p className="text-gray-300 max-w-3xl mx-auto text-lg leading-relaxed">
          DASTAAN'26 is more than just a freshers party; it's a bridge between generations. 
          Hosted by the Batch of '24, this evening is dedicated to welcoming our juniors 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
        {features.map((f, i) => (
          <motion.div
            ...
            className="emerald-glass p-8 rounded-2xl border border-gold-500/10 hover:border-gold-500/30 transition-all group"
          >
            ...
            <h4 className="text-xl font-display text-gold-300 mb-3">{f.title}</h4>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h3 className="text-3xl font-display text-gold-400 mb-6">The Batch of '24</h3>
          <p className="text-gray-300 mb-6 leading-relaxed">
            We are a group of visionaries who believe that every beginning should be legendary. 
            Our batch has spent months crafting this experience, from the emerald-gold decor 
            to the high-tech AR integration, ensuring that your first major event is nothing 
            short of magical.
          </p>
          <div className="space-y-4">
            <div className="flex items-center space-x-3 text-gold-300/80">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="aspect-video rounded-3xl overflow-hidden gold-border">
            <img 
          ...
          <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gold-500/20 backdrop-blur-xl rounded-2xl border border-gold-500/30 flex items-center justify-center p-4 text-center">
            <p className="text-gold-400 font-display text-xs font-bold leading-tight">ESTABLISHED TRADITION</p>
          </div>
        </motion.div>
      </div>
    </div>
